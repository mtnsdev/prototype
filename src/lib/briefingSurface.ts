...
/** Product / destination browse grids on inset rails — paper card surface (`--surface-card`), same lift as briefing widgets. */
export const DIRECTORY_BROWSE_CARD_SURFACE = cn(
