    ...
    <div className="h-full flex flex-col bg-[#0C0C0C] overflow-hidden">
      ...
      <header className="border-b border-[rgba(255,255,255,0.08)] p-4 flex flex-wrap items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-lg font-semibold text-[#F5F5F5] truncate">{product.name}</h1>
      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === "overview" && (
          <div className="space-y-4 max-w-3xl">
            <section>
              <h2 className="text-sm font-medium text-[rgba(245,245,245,0.5)] mb-2">Core</h2>
              <dl className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                <div><dt className="text-[rgba(245,245,245,0.5)]">Name</dt><dd className="text-[#F5F5F5]">{product.name}</dd></div>
                <div><dt className="text-[rgba(245,245,245,0.5)]">Category</dt><dd className="text-[#F5F5F5]">{CATEGORY_LABELS[product.category]}</dd></div>
                <div><dt className="text-[rgba(245,245,245,0.5)]">Status</dt><dd className="text-[#F5F5F5]">{product.status}</dd></div>
                <div><dt className="text-[rgba(245,245,245,0.5)]">Location</dt><dd className="text-[#F5F5F5]">{[product.city, product.country].filter(Boolean).join(", ")}</dd></div>
              </dl>
            </section>
            {product.description && (
              <section>
                <h2 className="text-sm font-medium text-[rgba(245,245,245,0.5)] mb-2">Description</h2>
