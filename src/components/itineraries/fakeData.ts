...
export const FAKE_ITINERARIES: Itinerary[] = [
  ...
  } as Itinerary,
  {
    ...
    currency: "EUR",
    total_vic_price: 18500,
    total_net_cost: 14200,
    total_margin: 4300,
  ...
  } as Itinerary,
  {
    ...
    currency: "EUR",
    total_vic_price: 22500,
    total_net_cost: 17800,
    total_margin: 4700,
  ...
  } as Itinerary,
  {
    ...
    currency: "EUR",
    tags: [],
    total_vic_price: 12200,
    total_net_cost: 9800,
    total_margin: 2400,
    total_commission: 1460,
    data_ownership_level: "Advisor",
    created_by: "2",
    created_at: iso(now),
    updated_at: iso(now),
