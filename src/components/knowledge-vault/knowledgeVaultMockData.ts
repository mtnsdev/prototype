...
function getMockDocumentsRaw(): KnowledgeDocument[] {
  return [
    ...
    {
      id: "doc-other-1",
      title: "Client Notes — Williams Anniversary Trip",
      source_id: "src-gdrive-personal",
      source_type: DataSourceType.GoogleDrivePersonal,
      source_name: GPERSONAL,
      data_layer: "advisor",
      ...
      file_size_kb: 154,
      content_summary:
        "Private client planning notes (another advisor). Visible to admins only when Show all is enabled.",
      tags: ["Client Work", "Planning"],
      ingestion_status: "indexed",
      ingested_at: d(5),
