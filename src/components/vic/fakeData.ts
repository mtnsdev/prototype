...
export const FAKE_VICS: VIC[] = [
  // —— Owned by OTHER (Marco / user-marco) — Shared with Me (full) ——
  {
    ...
    linked_product_ids: ["prod-enable-001", "prod-agency-004", "prod-advisor-002"],
    acuityProfile:
