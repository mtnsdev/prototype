...
export const FAKE_VICS: VIC[] = [
  // —— Owned by OTHER (Marie "2") — Shared with Me (full) ——
  {
    ...
    field_provenance: {
      ...
      company: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
      title: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
      preferred_name: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
      dietary_restrictions: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
      accessibility_needs: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
      referral_source: { source: "acuity", provider: "Gemini", confidence: "high", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)), verified: false },
    ...
    relationship_insights: [
      { id: "ri1", text: "Board member at Kering Group", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { id: "ri2", text: "Featured in Virtuoso Life Magazine, March 2025", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      ...
      { id: "ri4", text: "Regular attendee of Monaco Yacht Show (VIP)", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
    ],
    travel_discovered_preferences: [
      ...
      { id: "td2", text: "Frequent Aman guest (3+ stays)", profile_type: "leisure", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { id: "td3", text: "Wine enthusiast — Barolo & Burgundy regions", profile_type: "leisure", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { id: "td4", text: "Prefers first class on Air France", profile_type: "business", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { id: "td5", text: "Allergic to shellfish", profile_type: "leisure", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { id: "td6", text: "Anniversary: June 15", profile_type: "leisure", provider: "Gemini", sourced_at: iso(new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000)) },
    ],
    created_by: "2",
    createdBy: "2",
