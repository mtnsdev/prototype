...
- **Seeds**: expanded mock products, rep firms, and a **consortium program registry** seed so Partner Portal can show program coverage before hotels are linked.
...
| DIR-106 | Partner program registry feed | Supplier/CRM APIs | Single source per program; conflict resolution UI; Partner Portal reflects feed-backed rows. |
...
- Existing partner-portal directory logic and VIC permission helpers
